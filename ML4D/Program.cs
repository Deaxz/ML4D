    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (string s in examples)
            {
             ...
             //         Console.WriteLine("^ Is pretty print");
             //         
             //         // Symbol Table construction and Declaration visit
             //         SymbolTable symbolTable = new SymbolTable();
             //         var symbolVisitor = new SymbolTableVisitor(symbolTable);
             //         symbolVisitor.Visit(ast);
             //
             //         // Type checking
             //         var typecheckVisitor = new TypeCheckVisitor(symbolTable);
